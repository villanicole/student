...
<table border="0" width="500" align-item="center" class="demo-table">
...
<tr>
<tr>
<td>Course/Year/Block</td>
<td><input type="text" class="demoInputBox" name="course/year/block"minlength="3" maxlength="16"  value="<?php if(isset($_POST['course/year/block'])) echo $_POST['block/year']; ?>" required ></td>
</tr>
<tr>
<td>Address</td>
<td><input type="text" class="demoInputBox" name="address"minlength="3" maxlength="16"  value="<?php if(isset($_POST['address'])) echo $_POST['address']; ?>" required ></td>
</tr>
<tr>
<td>Gender</td>
...
<tr>
<td colspan=2>
 <input type="submit" name="insert_button" value="Apply" class="btnRegister" required ></td>
</tr>
</table>
