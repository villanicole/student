	...
	<ul id = "menu" class = "nav menu">
		...
		<li><a href = ""><i class = "glyphicon glyphicon-user"></i> Accounts</a>
			<ul>
                ...
                <li><a href = "students_details.php"><i class = "glyphicon glyphicon-user"></i> Students</a></li>
				
			</ul>
		</li>
		<li><a href = "activity.php"><i class = "glyphicon glyphicon-calendar"></i>Upload internships</a></li>
		
		<li><a href = "student.php"><i class = "glyphicon glyphicon-ruble"></i> Students Application</a></li>
